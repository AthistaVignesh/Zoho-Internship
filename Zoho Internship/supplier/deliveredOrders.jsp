...
<body>
	<div class="titleCss">
	  ...
	  <div class="search-container">
             	...
             	<form action="filterByCategoryAct?showStatus=Delivered" method='post'>
...
document.getElementById("totalRate").innerHTML ="The total price of products sold based on the given criteria is  <i class=\"fa fa-inr\"></i> "+totalPrice;
</script>
</body>
</html>