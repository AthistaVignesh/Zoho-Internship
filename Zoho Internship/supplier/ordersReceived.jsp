...
<body>
	...
	<h3 class="alert" id="alert1" style="display:none">Order Cancelled Successfully!</h3>

	<h3 class="alert" id="alert2" style="display:none">Successfully Updated!</h3>

	<h3 class="alert" id="alert3" style="display:none">Some thing went wrong! Try Again!</h3>
	 <div class="search-container">
            	
             	<form action="filterByCategoryAct?showStatus=Processing" method='post'>
...
for(var i = 0; i <= size; ++i){	  
	   ...
	   cell[j].innerHTML = "<a href=\"removeProdFromOrderAct?productId="+object[13]['prod_id']+"&consumerId="+object[14]['consumer_id']+"\">Cancel <i class='fas fa-window-close'></i></a>";
	   cell[j+1]=newRow[i].insertCell(j+1);
	   cell[j+1].innerHTML = "<a href=\"deliveredProdFromOrderAct?productId="+object[13]['prod_id']+"&consumerId="+object[14]['consumer_id']+"\">Delivered <i class='fas fa-dolly'></i></i></a>";
	   }
...
document.getElementById("totalRate").innerHTML ="The total price of products received based on the given criteria is  <i class=\"fa fa-inr\"></i> "+totalPrice;
</script>
</body>
</html>